...
${RECEIPT_FOLDER}       ${OUTPUT_DIR}${/}receipts
${SCREENSHOT_FOLDER}    ${OUTPUT_DIR}${/}screenshot
...
Store the receipt as a PDF file
    ...
    [Arguments]    ${index}
    ${pdf}=    Set Variable    ${OUTPUT_DIR}${/}receipts/order_${index}.pdf
...
Take a screenshot of the robot
    ...
    [Arguments]    ${index}
    ${screen}=    Set Variable    ${OUTPUT_DIR}${/}screenshot/order_${index}.png
...
Embed the robot screenshot to the receipt PDF file
    ...
    ${result}=    Set Variable    ${OUTPUT_DIR}${/}result/result_${index}.pdf
